...
## 1 Authentication Service (`services/auth/authApi.ts`)
...
## 2 Crop Listing Service (`services/crop-listing/cropApi.ts`)
...
## 3 Weather Widget Component (`components/WeatherWidget.tsx`)
