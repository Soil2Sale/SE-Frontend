          ...
          <div className="max-h-75 overflow-y-auto py-1">
            {LANGUAGES.map((lang) => (
              <button
                ...
                className={`w-full text-left px-4 py-2 text-sm hover:bg-[#E8F5E9] dark:hover:bg-[#1a1a1a] transition-colors flex items-center justify-between group ${
                  currentLang === lang.code
                    ? "bg-[#E8F5E9] dark:bg-[#1a1a1a] text-[#1B5E20] font-bold"
                    : "text-[#263238] dark:text-[#E8F5E9]"
                }`}
              >
