    ...
    <div className="min-h-screen bg-[#F3F6F3] dark:bg-[#0a0a0a] text-[#11231D] dark:text-[#E8F5E9] flex flex-col">
      ...
      <nav className="w-full px-6 py-4 flex justify-between items-center bg-transparent  sticky top-0 z-50 ">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-[#11231D] dark:text-[#D6F364]">Soil2Sale</span>
        </div>

        <div className="flex gap-4">
          <Link href="/auth/login" className="px-4 py-2 text-sm font-semibold text-[#11231D] dark:text-[#E8F5E9] hover:bg-[#11231D]/5 rounded-xl transition-all">
            Sign In
          </Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-10 w-80 h-80 bg-[#11231D]/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "2s" }} />

        <div className="max-w-4xl space-y-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <p className="text-xl text-[#4F6F52] dark:text-[#86efac] max-w-2xl mx-auto leading-relaxed">
            Connect directly with local farmers. Buy and sell fresh, organic produce without middlemen.
            Empowering growers and nourishing communities.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/auth/register" className="px-8 py-4 text-base font-bold text-[#11231D] bg-[#D6F364] dark:bg-[#D6F364] dark:text-[#11231D] rounded-2xl shadow-xl shadow-[#D6F364]/30 hover:shadow-2xl hover:shadow-[#D6F364]/40 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 group">
              Get Started
        ...
        {/* Feature Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-24 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300">
          {[
            {
              icon: Leaf,
              title: "100% Organic",
            ...
            <div key={idx} className="bg-white dark:bg-[#111] p-8 rounded-3xl border border-[#11231D]/5 dark:border-[#333] hover:border-[#11231D]/20 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#11231D] dark:text-[#E8F5E9] mb-2">{feature.title}</h3>
