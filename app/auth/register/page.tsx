...
import { ArrowLeft, Smartphone, ShieldCheck, ArrowRight, User } from "lucide-react";
...
export default function RegisterPage() {
    ...
    return (
        <div className="flex min-h-screen w-full bg-[#FAFAFA] dark:bg-[#0a0a0a] text-[#263238] dark:text-[#E8F5E9] overflow-hidden">
            ...
            <div className="absolute top-8 right-8 z-50 animate-in fade-in duration-700 delay-300">
                <LanguageSelector currentLang={lang} onLanguageChange={setLang} />
            </div>

            {/* Left Side - Hero Image/Brand - SLIDE FROM LEFT */}
            <div className="hidden lg:flex w-1/2 flex-col items-center justify-center bg-[#1B5E20] dark:bg-[#052b14] p-12 relative overflow-hidden animate-in slide-in-from-left duration-1000 fill-mode-forwards">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1595837941018-8686ca8e2101?q=80&w=2940&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                <div className="max-w-lg text-center space-y-6 relative z-10">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-[#A5D6A7] mb-6 shadow-xl shadow-[#A5D6A7]/20 animate-in fade-in zoom-in duration-700 delay-500">
                        <span className="text-4xl font-bold text-[#1B5E20]">S</span>
                    </div>
                    <h1 className="text-5xl font-bold tracking-tight text-white animate-in slide-in-from-bottom-4 duration-700 delay-700">{t.join}</h1>
                    <p className="text-xl text-[#E8F5E9]/90 animate-in slide-in-from-bottom-4 duration-700 delay-900">
                        {t.joinSubtitle}
                    </p>
                </div>
            </div>
            ...
            <div className="flex w-full lg:w-1/2 items-center justify-center p-8 sm:p-12 relative animate-in slide-in-from-right duration-1000 fill-mode-forwards">
                <Link href="/" className="absolute top-8 left-8 p-2 rounded-full hover:bg-[#1B5E20]/5 transition-colors">
                    <ArrowLeft className="h-6 w-6 text-[#1B5E20]" />
                </Link>
                <div className="w-full max-w-[420px] space-y-8">
                    <div className="text-center lg:text-left space-y-3">
                        <h2 className="text-4xl font-bold tracking-tight text-[#1B5E20] dark:text-[#A5D6A7]">{t.createAccount}</h2>
                        ...
                        {step === 1 ? (
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="name" className="text-sm font-bold leading-none text-[#1B5E20] dark:text-[#E8F5E9] ml-1">
                                        {t.fullName}
                                    </label>
                                ...
                                {/* Phone Number Input */}
                                <div className="space-y-2">
                                    <label htmlFor="phone" className="text-sm font-bold leading-none text-[#1B5E20] dark:text-[#E8F5E9] ml-1">
                                        {t.phoneLabel}
                                    </label>
                                    <div className="relative group">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="email" className="text-sm font-bold leading-none text-[#1B5E20] dark:text-[#E8F5E9] ml-1">
                            ...
                            <div className="animate-in fade-in slide-in-from-right duration-500">
                                ...
                                <div className="text-[10px] text-center text-[#263238]/60 leading-tight px-4 mt-6">
                                    {t.agreeTerms} <Link href="/terms" className="underline hover:text-[#1B5E20]">{t.terms}</Link> {t.and} <Link href="/privacy" className="underline hover:text-[#1B5E20]">{t.privacy}</Link>.
                                </div>

                                {/* Sign Up Button */}
                                <button
                                    className="w-full rounded-2xl bg-[#1B5E20] dark:bg-[#2E7D32] px-5 py-3.5 text-sm font-bold text-white shadow-lg shadow-[#1B5E20]/20 hover:shadow-xl hover:shadow-[#1B5E20]/30 hover:bg-[#2E7D32] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 mt-4"
                                >
                                    {t.createAccount}
                                </button>
                            </div>
                    ...
                    <div className="text-center">
                        <Link href="/auth/login" className="text-sm font-semibold text-[#1B5E20] hover:underline hover:text-[#2E7D32] transition-colors">
